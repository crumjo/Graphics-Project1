...
class Axes {
    constructor (gl) {
        ...
        this.xaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, 10, xcolor, xcolor);
        this.yaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, 10, ycolor, ycolor);
        this.zaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, 10, zcolor, zcolor);
